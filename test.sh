...
docker run -i --rm --name some-buildpack quay.io/ibm/buildpack-deps:bullseye-scm apt-get update -y | grep s390x
docker rmi quay.io/ibm/buildpack-deps:bullseye-scm
